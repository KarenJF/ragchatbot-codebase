...
"""
    ...
    def _handle_sequential_tool_execution(self, initial_response, base_params: Dict[str, Any], tool_manager):
        ...
        while current_round <= MAX_ROUNDS:
            ...
            tool_results, has_tool_failures = self._execute_single_tool_round(current_response, tool_manager)
            ...
            has_tool_use = any(block.type == "tool_use" for block in current_response.content)
